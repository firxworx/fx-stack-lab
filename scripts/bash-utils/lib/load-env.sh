...
#######################################################################################################################
# Bash function that loads an env file at the provided path and exports them as variables in the bash environment.
#
# details:
...
#
# usage:
# - import into a bash script using `source` or `.`: `source ../lib/load-env` or `. ../lib/load-env`
# - call the function specifying path as the first argument: `loadEnv /path/to/.env`
#######################################################################################################################
